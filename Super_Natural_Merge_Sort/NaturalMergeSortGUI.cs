...
namespace Super_Natural_Merge_Sort
{
    ...
    /*protected void DrawDirection(Point Right, Point Left, int y, int D)
       {

           Pen myPen = new Pen(Color.White);
           myPen.Width = 3;
           Point left_point = new Point(Left.X, Left.Y + 50);
           Point right_point = new Point(Right.X + 40, Right.Y + 50);
           graphics.DrawLine(myPen, right_point, left_point);


           if (D == 1)
           {
               graphics.DrawLine(myPen, right_point, new Point(right_point.X - 5, right_point.Y - 5));
               graphics.DrawLine(myPen, right_point, new Point(right_point.X - 5, right_point.Y + 5));
           }
           else
           {
               graphics.DrawLine(myPen, left_point, new Point(left_point.X + 5, left_point.Y - 5));
               graphics.DrawLine(myPen, left_point, new Point(left_point.X + 5, left_point.Y + 5));
           }
